...
def update_output(n_clicks):
    if n_clicks is None:
        return dcc.Graph(figure=handler.get_type_trajectory_3D(true_size=0, type='j'), id='3d'), dcc.Graph(figure=handler.get_type_trajectory_xy(type='j'))
    else:
        return dcc.Graph(figure=handler.get_type_trajectory_3D(true_size=1, type='j'), id='3d'), dcc.Graph(figure=handler.get_type_trajectory_xy(type='j'))
